...
export function Sidebar() {
  ...
  return (
    <Sider width={260} theme="light" style={{ position: "fixed", height: "100vh", zIndex: "50" }}>
      {/* === Cabeçalho com logo === */}
      <div className="flex flex-col justify-between h-full">
          ...
          <div className="py-4 px-6 border-b border-gray-100">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500">Campo Mourão</p>
              </div>
            </div>
          </div>
          ...
          <Menu
            ...
            items={[
              ...
              },
              {
                ...
                icon: <TeamOutlined />,
                label: (
                  <Link href="/gestao-de-usuario">Gestão de Usuários</Link>
                ),
              },
              {
                key: "8",
        ...
        <div className="py-4 px-6 border-t border-gray-100">
          ...
          {/* deixei aqui só pra você não se esquecer como ele funciona, pode remover se não for precisar :) */}
          {/* <Button
            block
            size="small"
